...
{
    public class BlogPhotoStorageRepository : IBlogPhotoStorageRepository
    {
        private readonly GCSConfigOptions _options;
        private readonly ILogger<BlogPhotoRepository> _logger;
        private readonly GoogleCredential _googleCredential;

        public BlogPhotoStorageRepository(IOptions<GCSConfigOptions> options, ILogger<BlogPhotoRepository> logger)
        {
