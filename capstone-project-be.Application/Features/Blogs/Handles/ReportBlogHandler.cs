...
{
    public class ReportBlogHandler : IRequestHandler<ReportBlogRequest, object>
    {
        private readonly IUnitOfWork _unitOfWork;

        public ReportBlogHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<object> Handle(ReportBlogRequest request, CancellationToken cancellationToken)
        {
